...
Figure \ref{fig: learning policy} presents the reward for the first step, where we can see...

\begin{figure}
	\includegraphics[width=\linewidth]{example-image-a}
	\caption{Reward for learning $\policy$ using the pre-trained $\nn$.}
	\label{fig: learning policy}
\end{figure}

Figure \ref{fig: adapting policy} presents the reward for the second step, showing that ...

\begin{figure}
	\includegraphics[width=\linewidth]{example-image-a}
	\caption{Reward for learning $\policy$ for the modified robot using the pre-trained $\nn$ and $\policy$.}
	\label{fig: adapting policy}
\end{figure}