...
Nevertheless, for low-cost or in-house-built robots, achieving a satisfactory forward kinematics is not a trivial task, and often learning-based methods are adopted \cite{zajc2022low}.
